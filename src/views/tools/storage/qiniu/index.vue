        ...
        <el-table-column prop="name" :show-overflow-tooltip="true" label="文件名">
          <template slot-scope="scope">
            <el-popover placement="right-start" trigger="hover">
              <el-image :src="scope.row.url + (scope.row.bucket === 'bamboo-smoke' ? '-hoverImg' : '')" style="height: 500px">
        ...
        <el-table-column prop="url" label="预览">
          <template slot-scope="scope">
            <el-popover placement="right-start" trigger="hover">
              ...
              <el-image slot="reference" :src="scope.row.url + (scope.row.bucket === 'bamboo-smoke' ? '-listThumb' : '')" style="height: 30px" @click="download(scope.row.id)">
                <div slot="error" class="image-slot">
                  <i class="el-icon-picture-outline" />
                </div>
              </el-image>
